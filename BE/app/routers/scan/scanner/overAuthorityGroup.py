...
#2_1_2 과도한 권한 IAM Group
class overAuthorityGroup:
    def __init__(self):
    ...
    def list_access_service(self):
        ...
        self.sub = dict()
        # 아예 사용 안한 사용자 리스트와
        self.sub['NotExistServiceGroup'] = list() 
        # 사용했지만 90일이 경과된 리스트
        ...
        for group in self.groups:
            ...
            if not 'ServicesLastAccessed' in entity:
                self.sub['NotExistServiceGroup'].append(group.name)
